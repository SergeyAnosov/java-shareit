...
class ItemServiceImplTest {
    ...
    void getById_Success_CheckGetOwnerSuccess() {
        ...
        when(bookingRepository.findFirstByItem_IdAndStartIsBeforeAndStatusOrderByEndDesc(anyLong(), any(), any())).thenReturn(booking);
        when(bookingRepository.findFirstByItem_IdAndStartIsAfterAndStatusOrderByEndDesc(anyLong(), any(), any())).thenReturn(booking);
